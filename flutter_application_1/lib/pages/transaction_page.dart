...
class _TransactionPageState extends State<TransactionPage> {
  ...
  Future update(int transactionId, int amount, int categotyId,
      DateTime transactionDate, String nameDetail) async {
    return await database.updateTransactionRepo(
        transactionId, amount, categotyId, transactionDate, nameDetail);
  }
  ...
  void updateTransactionView(TransactionWithCategory transactionWithCategory) {
    ...
    dateController.text = DateFormat("yyyy-MM-dd")
        .format(transactionWithCategory.transaction.transactions_date);
              ...
              child: Row(
                ...
                children: [
                  Switch(
                    ...
                    inactiveTrackColor: Color.fromARGB(255, 82, 245, 128),
                    inactiveThumbColor: Color.fromARGB(255, 92, 218, 134),
